...
class CustomActionsManager {
    constructor(panelId, actionListId, actionFormId, editActionTitleId, actionIdInputId, actionNameInputId, upAngleInputId, downAngleInputId, keypointsInputId, submitBtnId, cancelEditBtnId, customActionsBtnId) {
